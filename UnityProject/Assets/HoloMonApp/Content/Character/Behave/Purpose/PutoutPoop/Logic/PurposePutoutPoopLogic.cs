...
namespace HoloMonApp.Content.Character.Behave.Purpose.PutoutPoop
{
    ...
    /// うんちを行う行動ロジック
    /// </summary>
    public class PurposePutoutPoopLogic : MonoBehaviour, HoloMonPurposeBehaveIF
    {
        /// <summary>
        /// 目的行動共通参照
        /// </summary>
        ...
        private PurposePutoutPoopData p_Data => (PurposePutoutPoopData)p_Info.PurposeData;
        ...
        public async UniTask<bool> StartLogicAsync(PurposeInformation a_Porpuse)
        {
            ...
            // うんちモードのアクションを実行待機する
            modeLogicResult = await p_PurposeReference.ActionModeLogic.ActionPutoutPoopAcync();
