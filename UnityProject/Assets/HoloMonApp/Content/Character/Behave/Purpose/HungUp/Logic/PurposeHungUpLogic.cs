...
namespace HoloMonApp.Content.Character.Behave.Purpose.HungUp
{
    ...
    /// 掴まれる行動ロジック
    /// </summary>
    public class PurposeHungUpLogic : MonoBehaviour, HoloMonPurposeBehaveIF
    {
        /// <summary>
        /// 目的行動共通参照
        /// </summary>
        ...
        private PurposeHungUpData p_Data => (PurposeHungUpData)p_Info.PurposeData;
        ...
        public async UniTask<bool> StartLogicAsync(PurposeInformation a_Porpuse)
        {
            ...
            // 持ち上げモードのアクションを実行待機する
            modeLogicResult = await p_PurposeReference.ActionModeLogic.ActionHungUpAcync();
