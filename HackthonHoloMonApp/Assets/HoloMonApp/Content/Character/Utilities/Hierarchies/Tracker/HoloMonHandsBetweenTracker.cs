...
{
    public class HoloMonHandsBetweenTracker : MonoBehaviour
    {
        [SerializeField]
        ...
        private void HeadTracking()
        {
            ...
            this.transform.position = Vector3.Lerp(
                p_AccessAPI.View.TransformsBoneAPI.RightHandWorldPosition,
                p_AccessAPI.View.TransformsBoneAPI.LeftHandWorldPosition,
                0.5f);
            this.transform.rotation = Quaternion.Lerp(
                p_AccessAPI.View.TransformsBoneAPI.RightHandWorldRotation,
                p_AccessAPI.View.TransformsBoneAPI.LeftHandWorldRotation,
                0.5f);
        }
